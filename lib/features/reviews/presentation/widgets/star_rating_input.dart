...
/// Read-only 5-star strip showing [rating] (rounded to the nearest star). For
/// per-review stars and rating-summary headers; use [StarRatingInput] when the
/// user should be able to tap a rating.
